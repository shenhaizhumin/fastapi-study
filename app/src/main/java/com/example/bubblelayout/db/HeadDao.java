 ...
 * DAO for table "HEAD".
*/
public class HeadDao extends AbstractDao<Head, String> {
    ...
    @Override
    protected final String updateKeyAfterInsert(Head entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(Head entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
